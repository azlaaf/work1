...
error_reporting(0);
   ...
   $img_name = $_FILES['pp']['name'];
         ...
         $sql = "INSERT INTO `userprofile` (`Entreprise`, `Adresse`, `Ville`, `Code_postal`, `patent_Number`, `cimr`, `N_d_CNSS`, `email`, `password`, `logo`, `phone`) VALUES ('$entreprise', '$adresse', '$ville', '$CP', '$nb', '$cnss', '$n_cnss',  '$email', '$password', '$img_upload_path', '$phone')";
          ...
          <form action="" method="post">
            <div class="user-details">
              ...
              <div class="input-box">
                ...
                <input type="number" placeholder="Enter your RC" name="cnss" >
              </div>

              <div class="input-box">
                <span class="details">cf. RC</span>
                <input type="number" placeholder="Enter your cf. RC"  name="n_cnss">
              </div>
